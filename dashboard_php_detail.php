...
$stmt = $pdo->prepare("
    ...
    LEFT JOIN (
        ...
        FROM lessons l2 
        WHERE l2.language = 'php'
    ) prev_lesson ON prev_lesson.order_num = l.order_num - 1 AND prev_lesson.order_num > 0
    LEFT JOIN progress prev_progress ON prev_progress.lesson_id = prev_lesson.id AND prev_progress.user_id = ? AND prev_progress.language = 'php'
...
$testStmt = $pdo->prepare("
    ...
    FROM test_results 
    WHERE user_id = ? AND language = 'php'
");
...
<head>
    <title>PHP Lessons - DevLab</title>
    ...
    <div class="container mx-auto px-4 ">
        ...
        <div class="flex justify-between items-center mb-8 pb-6 border-b bg-white shadow p-5 rounded">
            <div class="flex items-center">
                ...
                <h1 class="text-2xl font-bold">ภาพรวมหลักสูตร PHP</h1>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="view_test_results.php?language=php&type=pre"
                ...
                <p class="text-gray-600 text-sm">
                    แบบทดสอบนี้จะช่วยวัดความรู้พื้นฐานของคุณก่อนเริ่มเรียน PHP
                </p>
            </div>
            <!-- PHP Learning Resources Card -->
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">แหล่งเรียนรู้ PHP</h2>
                    <a href="content_knowledge.php?language=php"
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="view_test_results.php?language=php&type=post"
                            class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                ...
                <p class="text-gray-600 text-sm">
                    แบบทดสอบนี้จะวัดความรู้ของคุณหลังจากเรียน PHP ครบทุกบทเรียน
                </p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h2 class="text-xl font-semibold">ความคืบหน้าในการเรียนรู้ PHP ของคุณ</h2>
                    <p class="text-gray-600">
                        <?php echo count($completedLessons); ?> of <?php echo count($lessons); ?> lessons completed
                    </p>
                </div>
                <img src="img/php.png" alt="PHP Logo" class="h-12">
            </div>
                ...
                ?>
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        <div class="flex gap-2">
                            <a href="php_lesson.php?lesson=<?php echo $lesson['id']; ?>"
