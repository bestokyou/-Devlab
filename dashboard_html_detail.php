...
// Fetch all HTML lessons ordered by order_num instead of ID
$stmt = $pdo->prepare("
    SELECT l.*, 
    ...
    LEFT JOIN (
        ...
        FROM lessons l2 
        WHERE l2.language = 'html'
    ) prev_lesson ON prev_lesson.order_num = l.order_num - 1 AND prev_lesson.order_num > 0
    LEFT JOIN progress prev_progress ON prev_progress.lesson_id = prev_lesson.id AND prev_progress.user_id = ? AND prev_progress.language = 'html'
    WHERE l.language = 'html'
...
$testStmt = $pdo->prepare("
    ...
    FROM test_results 
    WHERE user_id = ? AND language = 'html'
");
...
<head>
    <title>HTML Lessons - DevLab</title>
    ...
    <script src="https://cdn.tiny.cloud/1/njbqtnvur3jtukowes953qfs3dypeiy734j6yzdwdbb8nkte/tinymce/7/tinymce.min.js"
    ...
    <div class="container mx-auto px-4 ">
        ...
        <div class="flex justify-between items-center mb-8 pb-6 border-b bg-white shadow p-5 rounded">
            <div class="flex items-center">
                ...
                <h1 class="text-2xl font-bold">ภาพรวมหลักสูตร HTML</h1>
            </div>
        ...
        <!-- แสดงผลข้อความแจ้งเตือนหลังจากทำแบบทดสอบ -->
        <?php if (isset($_SESSION['test_message'])): ?>
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
            <span class="block sm:inline"><?php echo htmlspecialchars($_SESSION['test_message']); ?></span>
            <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                <svg onclick="this.parentElement.parentElement.remove()"
                    ...
                    <title>Close</title>
                    <path
                        d="M14.348 14.849a1 1 0 0 1-1.414 0L10 11.414l-2.934 2.934a1 1 0 1 1-1.414-1.414l2.934-2.934-2.934-2.934a1 1 0 1 1 1.414-1.414L10 8.586l2.934-2.934a1 1 0 1 1 1.414 1.414L11.414 10l2.934 2.934a1 1 0 0 1 0 1.414z" />
                </svg>
            </span>
            <?php unset($_SESSION['test_message']); ?>
        </div>
        <?php endif; ?>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="view_test_results.php?language=html&type=pre"
                    ...
                    <?php else: ?>
                    <a href="html_pretest.php"
                        class="bg-yellow-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg transition-colors flex items-center gap-2">
                ...
                <p class="text-gray-600 text-sm">
                    แบบทดสอบนี้จะช่วยวัดความรู้พื้นฐานของคุณก่อนเริ่มเรียน HTML
                </p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">HTML แหล่งการเรียนรู้
                    </h2>
                    <a href="content_knowledge.php?language=html"
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mb-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="view_test_results.php?language=html&type=post"
                            class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                ...
                <p class="text-gray-600 text-sm">
                    แบบทดสอบนี้จะวัดความรู้ของคุณหลังจากเรียน HTML ครบทุกบทเรียน
                </p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h2 class="text-xl font-semibold">ความคืบหน้าการเรียนรู้ HTML ของคุณ</h2>
                    <p class="text-gray-600">
                        <?php echo count($completedLessons); ?> of <?php echo count($lessons); ?> บทเรียนเสร็จสิ้น
                    </p>
                </div>
                <img src="img/html.png" alt="PHP Logo" class="h-12">
            </div>
            <div class="w-full bg-gray-200 rounded-full h-4">
                <div class="php-gradient h-4 rounded-full transition-all duration-500"
                ...
                ?>
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        <div class="flex gap-2">
                            <a href="lesson.php?language=html&lesson=<?php echo $lesson['id']; ?>"
                                class="flex-1 text-center bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition">
                                ทบทวนบทเรียน
                            </a>
                        </div>
                        <?php else: ?>
                        <a href="lesson.php?lesson=<?php echo $lesson['id']; ?>"
